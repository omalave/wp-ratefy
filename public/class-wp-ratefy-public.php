...
class Wp_Ratefy_Public {
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/wp-ratefy-public.js', array( 'jquery' ), $this->version, false );
